...
try {
  ...
  if (
    ...
    JSON.stringify(capabilitiesPayload.capabilities?.sourceExtensions) !==
      JSON.stringify([".md", ".markdown", ".mdx", ".adoc", ".asciidoc", ".org", ".txt", ".properties", ".html", ".htm", ".xhtml", ".pdf", ".docx", ".json", ".yaml", ".yml", ".xml", ".toml"]) ||
    JSON.stringify(capabilitiesPayload.capabilities?.answerExtensions) !==
      JSON.stringify([".md", ".markdown", ".mdx", ".adoc", ".asciidoc", ".org", ".txt", ".properties", ".html", ".htm", ".xhtml", ".pdf", ".docx", ".toml"]) ||
