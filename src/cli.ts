...
Supported files:
  Answers: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX/Textile, text/log/INI/properties, HTML/XHTML, JSON/JSONL/NDJSON, YAML, XML, CSV/TSV, PDF, DOCX, and TOML
  Sources: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX/Textile, text/log/INI/properties, HTML/XHTML, JSON/JSONL/NDJSON, YAML, XML, CSV/TSV, PDF, DOCX, and TOML
