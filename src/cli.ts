...
Supported files:
  Answers: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX/Textile, text, HTML/XHTML, JSON/JSONL/NDJSON/JSON5/JSONC, YAML, XML/RSS/Atom, TOML, CSV/TSV, EML, PDF, and DOCX
  Sources: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX/Textile, text, HTML/XHTML, JSON/JSONL/NDJSON/JSON5/JSONC, YAML, XML/RSS/Atom, TOML, CSV/TSV, EML, PDF, and DOCX
