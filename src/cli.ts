...
Use --json for a machine-readable object with sorted source and answer arrays.
`,
...
Supported files:
  Answers: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX/Textile, text, HTML/XHTML, JSON/JSONL/NDJSON/JSON5/JSONC, YAML, XML, TOML, CSV/TSV, EML/EMLX, RTF, PDF, and DOCX
  Sources: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX/Textile, text, HTML/XHTML, JSON/JSONL/NDJSON/JSON5/JSONC, YAML, XML, TOML, CSV/TSV, EML/EMLX, RTF, PDF, and DOCX
