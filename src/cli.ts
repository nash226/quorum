...
Supported files:
  Answers: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX, text, HTML/XHTML, JSON/JSONL/NDJSON, YAML, XML, CSV/TSV, PDF, DOCX, and TOML
  Sources: Markdown/MDX/Quarto, AsciiDoc/Org, MediaWiki, reStructuredText, LaTeX, text, HTML/XHTML, JSON/JSONL/NDJSON, YAML, XML, CSV/TSV, PDF, DOCX, and TOML
