...
function sourceTitleFromPath(sourcePath: string): string {
  return basename(sourcePath).replace(/\.(?:md|markdown|mdx|adoc|asciidoc|org|textile|mediawiki|wiki|rst|tex|txt|text|html?|xhtml|pdf|docx|jsonl?|xml|ya?ml|toml|csv)$/i, "");
}
