...
test("splits sentences across vertical-tab line breaks", () => {
  assert.deepEqual(
    splitIntoSentences("Employees receive leave.\u000BManagers approve exceptions."),
    ["Employees receive leave.", "Managers approve exceptions."],
  );
});
