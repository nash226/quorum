...
test("imports reviewer decisions with overrides, notes, and quoted csv fields", () => {
  const report = importReviewerDecisions(`claim_id,claim_text,model_verdict,model_reason,evidence_titles,evidence_trust_levels,evidence_scores,evidence_quotes,reviewer_verdict,reviewer_notes
claim_1,"Employees receive 18 weeks of paid parental leave.",contradicted,"A closely matching approved source uses different numeric terms.","HR Policy",high,0.857,"Employees receive 12 weeks of paid parental leave.",verified,"Approved after checking the June addendum"
claim_2,"Employees receive free catered lunch every day.",unsupported,"No approved source contains enough overlapping policy language.","HR Policy",high,0.251,"No approved source snippet matched strongly enough.",,"Needs People Ops confirmation, not policy evidence"
claim_3,"Healthcare coverage begins after 30 days of employment.",verified,"The claim is strongly supported by an approved source.","HR Policy",high,0.992,"Healthcare coverage begins after 30 days of employment.",needs_review,"Reviewer wants legal to check:
...
test("imports batch reviewer decisions with answer path context", () => {
  const report = importReviewerDecisions(`answer_path,claim_id,claim_text,model_verdict,model_reason,evidence_titles,evidence_trust_levels,evidence_scores,evidence_quotes,reviewer_verdict,reviewer_notes
examples/answers/hr-answer.md,claim_1,Employees receive 12 weeks of paid parental leave.,verified,The claim is strongly supported by an approved source.,HR Policy,high,0.998,Employees receive 12 weeks of paid parental leave.,,
examples/answers/support-answer.md,claim_2,Refunds are available within 14 days of purchase.,contradicted,A closely matching approved source uses different numeric terms.,Support Playbook,medium,0.842,Refunds are available within 30 days of purchase.,needs_review,Escalate to support ops
`);
