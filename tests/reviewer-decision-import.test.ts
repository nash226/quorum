...
`),
  ...
  assert.equal(
    lines[1],
    "examples/answers/hr-answer.md,examples/answers/hr-answer.md,Employees receive 12 weeks of paid parental leave.,verified,Employees receive 12 weeks of paid parental leave.,The claim is strongly supported by an approved source.,Approved,2,1,1,0,2,0,0,0",
  );
  assert.equal(
    lines[2],
