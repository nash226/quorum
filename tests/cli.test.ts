...
test("evaluate filters shipped example fixtures by domain", async () => {
  ...
  assert.match(stdout, /Fixtures: 26/);
});
...
test("evaluate writes a one-row-per-domain summary csv", async () => {
  ...
  try {
    ...
    assert.match(summaryCsv, /^[^,\n]+,hr,26,0,0\.000,26,0,79,79,1\.000,100%,32,17,20,10,32,17,20,10$/m);
...
test("evaluate writes a one-row aggregate summary csv", async () => {
  ...
  try {
    ...
    assert.match(summaryCsv, /,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25|,75,74,1,0,0\.000,222,222,1\.000,100%,hr \| support,26 \| 49,0 \| 0,0\.000 \| 0\.000,26 \| 48,0 \| 1,1\.000 \| 1\.000,100% \| 100%,86,50,61,25,86,50,61,25/);
  } finally {
    await rm(tempDir, { recursive: true, force: true });
  }
});
...
test("evaluate writes the gate-aware result JSON to disk", async () => {
  ...
  try {
    ...
    assert.equal(payload.summary.fixtureCount, 75);
  } finally {
    await rm(tempDir, { recursive: true, force: true });
  }
});
...
test("review-queue combines reviewer workload and benchmark drift", async () => {
  ...
  try {
    ...
    assert.equal(overview.evaluation.fixtureCount, 75);
    ...
    assert.match(text, /Benchmark drift: 0\/75 mismatches \(0%\)/);
  } finally {
    await rm(tempDir, { recursive: true, force: true });
  }
});
