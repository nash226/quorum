...
test("top-level help lists every shipped command", async () => {
  ...
  assert.match(stdout, /Answers: Markdown\/MDX \(including MKDN\), AsciiDoc\/Org, text, HTML\/XHTML, PDF, DOCX, and TOML/);
  assert.match(stdout, /Sources: Markdown\/MDX \(including MKDN\), AsciiDoc\/Org, text, HTML\/XHTML, PDF, DOCX, JSON, YAML, XML, and TOML/);
