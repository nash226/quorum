...
test("help advertises the complete discovered input contract", async () => {
  ...
  assert.match(stdout, /Answers: Markdown\/MDX\/Quarto, AsciiDoc\/Org, MediaWiki, reStructuredText, LaTeX\/Textile, text\/log\/config, HTML\/XHTML\/MHT, JSON\/JSONL\/NDJSON\/JSON5\/JSONC, YAML, XML, TOML, CSV\/TSV, EML\/EMLX, RTF, PDF, and DOCX/);
  assert.match(stdout, /Sources: Markdown\/MDX\/Quarto, AsciiDoc\/Org, MediaWiki, reStructuredText, LaTeX\/Textile, text\/log\/config, HTML\/XHTML\/MHT, JSON\/JSONL\/NDJSON\/JSON5\/JSONC, YAML, XML, TOML, CSV\/TSV, EML\/EMLX, RTF, PDF, and DOCX/);
});
