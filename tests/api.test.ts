...
import {
  ...
  LIVEZ_PATH as SERVER_LIVEZ_PATH,
  VERSION_PATH as SERVER_VERSION_PATH,
...
test("programmatic API re-exports embedded server helpers and metadata", () => {
  ...
  assert.strictEqual(LIVEZ_PATH, SERVER_LIVEZ_PATH);
  assert.strictEqual(VERSION_PATH, SERVER_VERSION_PATH);
