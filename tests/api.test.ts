...
test("programmatic API exposes supported source and answer extensions", () => {
  assert.deepEqual([...SOURCE_EXTENSIONS], [".md", ".markdown", ".mdx", ".adoc", ".asciidoc", ".org", ".mediawiki", ".wiki", ".rst", ".tex", ".txt", ".text", ".html", ".htm", ".xhtml", ".pdf", ".docx", ".json", ".jsonl", ".jsonld", ".yaml", ".yml", ".xml", ".toml"]);
  assert.deepEqual([...ANSWER_EXTENSIONS], [".md", ".markdown", ".mdx", ".adoc", ".asciidoc", ".org", ".mediawiki", ".wiki", ".rst", ".tex", ".txt", ".text", ".html", ".htm", ".xhtml", ".pdf", ".docx", ".json", ".jsonl", ".jsonld", ".xml", ".toml"]);
});
