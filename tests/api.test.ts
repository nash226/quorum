...
test("programmatic API returns mismatch metadata for fixture file evaluation helpers", async () => {
  ...
  assert.deepEqual(batchResult.summary.domains, [
    ...
    },
    {
      ...
      matchedClaims: 135,
      totalExpectedClaims: 135,
      score: 1,
      scoreLabel: "100%",
      expectedSummary: { verified: 51, contradicted: 31, unsupported: 39, needs_review: 14 },
      actualSummary: { verified: 51, contradicted: 31, unsupported: 39, needs_review: 14 },
    },
  ]);
