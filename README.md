...
RTF answers and approved sources are now discovered and normalized into readable
evidence, so common rich-text policy exports can enter the same verification
