...
When an approved source does not provide a title, reports derive a clean title
from its filename and remove common export extensions such as `.json`, `.yaml`,
`.xml`, and `.toml`, keeping structured-policy evidence readable in reviewer
handoffs.
