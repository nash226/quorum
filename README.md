...
The OpenAPI contract now also regression-tests JSON success schemas for every
discovered GET endpoint, keeping discovery, health, version, and document
clients aligned with the published response shapes.
