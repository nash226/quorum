...
For setup, CLI commands, supported formats, report outputs, metadata, and development checks, see the [CLI guide](docs/cli-guide.md). The working product direction is documented in the [roadmap](docs/roadmap.md), with an auto-updated snapshot in [status](docs/status.md).
