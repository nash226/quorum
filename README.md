...
The package-script regression suite now runs `npm run review-queue -- ...
--json` against pending and reviewed claims, keeping the installed queue
overview counts aligned with the direct CLI contract.
