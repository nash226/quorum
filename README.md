...
- read one or more approved Markdown, text, exported HTML, JSON, or PDF source documents
...
Source files may include optional frontmatter metadata. JSON source exports are
accepted as UTF-8 text so their structured content remains visible to the
verifier and in evidence reports:
