...
It also sends that verification request with `application/vnd.quorum+json`,
protecting the documented `application/*+json` integration contract in the
published HTTP artifact.
