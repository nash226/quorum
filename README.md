...
Recursive answer/source discovery is covered for the published rich-text
aliases `.rst` and `.wiki`; use `npm run dev -- formats --json` to inspect the
full versioned extension contract before configuring an import workflow.
