...
Node integrations can also import the evaluation renderers from the package
entrypoint to produce scorecards and aggregate or domain summary CSVs without
starting the CLI.
