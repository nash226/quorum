...
Single-answer verification now regression-tests combining an explicitly named
approved source with files discovered from `--source-dir`, preserving both
source inputs in the evidence report.
