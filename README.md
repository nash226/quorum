...
test suite, keeping the documented local workflow aligned with CI. The latest
verification also covers the versioned format-discovery contract and the
packaged CLI/API smoke paths described above.
