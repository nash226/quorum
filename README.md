...
It also exports `renderReviewerQueueJson` for integrations that need the same
queue overview as newline-terminated, pretty-printed JSON without invoking the
CLI.
