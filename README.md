...
The evaluation suite includes a support password-reset fixture that exercises
verified, contradicted, and unsupported claims against the approved playbook.
