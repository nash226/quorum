...
Verification accepts Markdown, text, exported HTML/XHTML, JSON/YAML/XML exports, PDF, DOCX, and ODT
...
documents (`.docx`), and OpenDocument Text (`.odt`), plus JSON (`.json`), YAML (`.yaml`, `.yml`), XML (`.xml`), and TOML (`.toml`) exports. JSON, YAML, and TOML
