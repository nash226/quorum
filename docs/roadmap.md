...
- Improve claim extraction without hiding uncertainty, including localized
...
- Continue expanding approved-source export coverage, prioritizing formats that
  enterprise teams can export from shared mailboxes and calendars.
